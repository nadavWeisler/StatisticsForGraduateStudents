...
```{r}
require(ggplot2)
p<-ggplot(df_study_2, aes(x=Group, y=mainDV_sterility, group=Correction)) +
  geom_line(aes(color=Correction))+
  geom_point(aes(color=Correction))
p
```
